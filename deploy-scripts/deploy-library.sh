...
BUILD_PATH=$(ls $BASE_PATH/build/library/target/*.jar)
JAR_NAME=$(basename $BUILD_PATH)

echo "> Copy .jar file..."
DEPLOY_PATH=$BASE_PATH/library-jar/
...
IDLE_APPLICATION=$IDLE_PROFILE-library.jar
...
/home/ubuntu/app/nonstop/switch-library.sh